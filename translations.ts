...
export const TRANSLATIONS = {
  en: {
    ...
    warning: 'This is an estimate and errors may occur. For an exact price, please contact us at 3d-druck@zinit.ch.',
  ...
  de: {
    ...
    warning: 'Dies ist eine Schätzung und es können Fehler auftreten. Für einen genauen Preis kontaktieren Sie uns bitte unter 3d-druck@zinit.ch.',
